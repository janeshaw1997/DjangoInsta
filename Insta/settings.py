...
SECRET_KEY = '4lzxyz1jvq$mgxic&@9a)^pzk8j=v&b+if*9_fqg9s6=*5o9@8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*'] # allow everyone to visit the website


# Application definition
# if any new app has been added to the project, make sure update this list
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic', # for deploying static/ to the heroku server
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # dirs are relative directories, not absolute
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
